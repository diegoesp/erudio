...
namespace :db do
  ...
  task :populate => :environment do
    ...
    @category_sport.activities.create!(:name => "Fútbol", :featured => true)
    @category_sport.activities.create!(:name => "Tenis", :featured => true)
    ...
    Zone.create!(:name => "Flores", :featured => true)
    ...
    Zone.create!(:name => "Palermo", :featured => true)
    ...
    Zone.create!(:name => "Recoleta", :featured => true)
    ...
    Zone.create!(:name => "Villa Urquiza", :featured => true)
